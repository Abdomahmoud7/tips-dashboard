...
st.sidebar.write("This dashboard provides insights into the tips dataset, which contains information about restaurant bills and tips.")
st.sidebar.write("")
...
st.sidebar.write("")
st.sidebar.write("Made with :heart_eyes: by Eng. [Abdeltawab Mahmoud](https://www.linkedin.com/in/abdeltawab-mahmoud-ali-b6036b374/)")
